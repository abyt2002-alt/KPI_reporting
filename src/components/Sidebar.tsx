import { BarChart3, Database, Rocket, Target, TrendingUp } from "lucide-react";
  ...
  return (
    <aside className="w-64 bg-slate-950 text-white flex flex-col h-full shadow-2xl border-r border-white/5">
      <div className="p-4 border-b border-white/5 flex items-center gap-3">
        ...
        <div>
          <p className="text-base font-semibold text-white">Marketing Analytics</p>
        </div>
      </div>
      ...
      <div className="px-3 py-4 space-y-2">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white">KPI Dashboard</p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white">Cross-Channel Analysis</p>
            </div>
          </div>
        </button>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white">Counterfactual Analysis</p>
            </div>
          </div>
        </button>
